...
### Visual Aesthetic: Greek-Themed Pixel Art
- **Art Style**: Aesthetic pixel art with Greek/Hellenic theme
- **Card Size**: 64x96 pixels for optimal readability
- **Color Palette**: Limited to 16 colors for retro aesthetic
- **Theme Elements**: Greek patterns (meander/key), deities, pottery art style
- **UI Style**: Consistent pixel art for all interface elements
- **Claude Creates Assets**: Claude should generate the pixel art assets directly using code
...
git worktree add ../kseri-game-logic -b feature/game-logic
git worktree add ../kseri-server -b feature/websocket-server  
git worktree add ../kseri-assets -b feature/pixel-art
...
```bash
# Terminal 1: Game Logic (Tasks #3, #4)
cd ../kseri-game-logic && claude

# Terminal 2: WebSocket Server (Task #10)
cd ../kseri-server && claude

# Terminal 3: Pixel Art Assets (Task #16)
cd ../kseri-assets && claude
```
...
git push origin feature/pixel-art

# From main repository
git pull origin feature/game-logic
